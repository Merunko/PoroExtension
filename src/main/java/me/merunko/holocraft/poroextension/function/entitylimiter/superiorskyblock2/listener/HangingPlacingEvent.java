...
public class HangingPlacingEvent implements Listener {
    ...
    public void onHangingEntityPlaced(HangingPlaceEvent event) {
        ...
        Chunk placedOnChunk = event.getEntity().getChunk();
        Island island = ssbHook.getIslandByChunk(placedOnChunk);
