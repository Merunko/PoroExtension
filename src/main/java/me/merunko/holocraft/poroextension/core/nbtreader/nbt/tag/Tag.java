package me.merunko.holocraft.poroextension.core.nbtreader.nbt.tag;
 ...
 * If an instance is nested further than allowed, a {@link me.merunko.holocraft.poroextension.core.nbtreader.io.MaxDepthReachedException} will be thrown.
...
public abstract class Tag<T> implements Cloneable {
     ...
     * @throws me.merunko.holocraft.poroextension.core.nbtreader.io.MaxDepthReachedException If the maximum nesting depth is exceeded.
     * */
    @Override
