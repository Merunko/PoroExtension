...
import me.merunko.holocraft.poroextension.core.nbtreader.nbt.io.NBTDeserializer;
import me.merunko.holocraft.poroextension.core.nbtreader.nbt.io.NBTSerializer;
import me.merunko.holocraft.poroextension.core.nbtreader.nbt.io.NamedTag;
...
import static me.merunko.holocraft.poroextension.core.nbtreader.mca.LoadFlags.*;
...
public class Chunk implements Iterable<Section> {
    ...
    private void initReferences(long loadFlags) {
        ...
        //if ((level = data.getCompoundTag("Position")) == null) {
        //    throw new IllegalArgumentException("data does not contain \"Position\" tag");
        //}
